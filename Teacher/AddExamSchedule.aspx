<%@ Page Language="C#" MasterPageFile="~/Teacher/Teacher.master" AutoEventWireup="true"
    CodeFile="AddExamSchedule.aspx.cs" Inherits="AddExamSchedule" Title="Untitled Page" %>
  ...
  function check()
   ...
   function Enable()
   {
    ...
    <table align="center" cellpadding="0" cellspacing="5" class="border1" width="600">
        ...
        <tr>
            <td align="right">
                <font color="red">*</font><span><b>Name of Exam:</b></span>
            </td>
            <td align="left">
        ...
        <tr>
            <td align="right">
                <font color="red">*</font><span><b>Date:</b></span>
            </td>
            <td align="left">
        ...
        <tr>
            <td align="right">
                <font color="red">*</font><span><b>Upload the Exam Schedule:</b></span>
            </td>
            <td align="left">
        ...
        <tr>
            ...
            <td align="left">
                <asp:Button ID="Submit" runat="server" Text="" CssClass="button" OnClick="SubMit_Click"
