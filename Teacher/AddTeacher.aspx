    ...
    <table cellspacing="5" cellpadding="0" align="center" width="600" class="border1">
        <tr>
            <td class="border" colspan="5" align="center">
                <b class="title">Add Teacher</b></td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="right" width="50%">
                <font color="red">*</font><span><b>First Name:</b></span>&nbsp;</td>
            <td align="left">
        ...
        <tr>
            <td align="right">
                <font color="red">*</font><span><b>Abbreviation:</b></span>
            </td>
        ...
        <tr>
            <td class="bg" align="right">
                <font color="red">*</font><span><b>Subject:</b></span>
            </td>
            <td colspan="2" align="left">
                <asp:ListBox ID="LstBSubject" runat="server" Width="129px" SelectionMode="Multiple">
                </asp:ListBox><br />
                <span><span></span></span>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="2" width="30%" style="height: 24px" align="left">
        ...
        <tr>
            ...
            <td colspan="2" align="left">
                <input id="TxtState" runat="server" onblur="upercase(this.id)" onfocus="colorset(this.id)"
        ...
        <tr>
            ...
            <td colspan="2" align="left">
                <input id="TxtCountry" runat="server" onblur="upercase(this.id)" onfocus="colorset(this.id)"
                    onkeypress="return noNumbers(event)" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="right">
                <font color="red">*</font><span><b> EmailID:</b></span>
            </td>
            <td align="left">
        ...
        <tr>
            ...
            <td align="left">
                <input id="TxtMoreInfo" runat="server" onblur="upercase(this.id)" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="left">
                <asp:Button ID="Btm_AddTeacher" runat="server" OnClick="Btm_AddTeacher_Click" CssClass="button" onclientclick="return check(this);"
                    Text="Update" Width="79px" />
